  ...
  const loadData = async (showRetryIndicator = false) => {
    try {
      ...
      try {
        ...
        console.warn('⚠️ Test de connexion échoué, tentative de chargement direct:', testError.message);
      }
      ...
      try {
        ...
        throw new Error(`Erreur lors du chargement des membres: ${memberError.message}`);
      }
      ...
      try {
        ...
        throw new Error(`Erreur lors du chargement des présences: ${presenceError.message}`);
      }
  ...
  const ListView = () => (
    <div className="space-y-3">
      {visibleMembers.map((member) => {
        ...
        // Debug pour vérifier les calculs - pour TOUS les membres avec des incohérences
        ...
        if (totalPresencesInPeriod !== totalVisiblePresences) {
          console.log(`⚠️ INCOHÉRENCE membre ${member.badgeId} (${member.name} ${member.firstName}):`, {
            badgeAffiche: totalPresencesInPeriod,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {visibleMembers.length === 0 ? (
          <div className="bg-white rounded-xl shadow-lg p-12 text-center border border-gray-200">
            ...
            <p className="text-gray-500 mb-6">Aucune présence n'a été enregistrée sur cette période ou avec ces filtres.</p>
            <button
              onClick={handleRetry}
