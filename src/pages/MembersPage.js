                  ...
                  {filteredMembers.map((member) => {
                    ...
                    return (
                      <tr
                        ...
                        className="hover:bg-gray-50 dark:hover:bg-gray-700 hover:scale-[1.2] hover:shadow-md hover:border-blue-300 transition-all duration-400 transform-gpu member-row"
