                  ...
                  {filteredMembers.map((member) => {
                    ...
                    return (
                      <tr
                        ...
                        className="hover:bg-gray-50 dark:hover:bg-gray-700 hover:scale-[1.02] hover:shadow-xl hover:border-blue-300 transition-all duration-400 transform-gpu member-row"
